...
import { changePassword, resetPasswordWitnCredentials } from "@/app/_authActions"; // Assuming you have a changePassword function
...
const ResetPassword = ({ token }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await resetPasswordWitnCredentials( token, newPassword );
  ...
  return (
    <div className="pt-[300px] w-[300px] min-h-screen flex flex-col items-center mx-auto">
      ...
      {/* Form for new password, confirm password, and old password input */}
      <form
