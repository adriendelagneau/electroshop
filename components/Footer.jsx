...
const Footer = () => {
  return (
    ...
    <footer className="relative pt-8 pb-6 bg-skin-fill text-skin-inverted">
          ...
          <div className="w-full px-4 lg:w-6/12">
            ...
            <div className="mt-6 mb-6 lg:mb-0">
              ...
              <div className='flex gap-6'>
                ...
                <Link href={"/#"} className='w-10 h-10 p-1 rounded-full bg-skin-fill hover:text-[#FFFC00] transition-all cursor-pointer'>
                ...
                <Link href={"/#"} className='w-10 h-10 p-1 rounded-full bg-skin-fill hover:text-[#000000] transition-all cursor-pointer'>
                ...
                <Link href={"/#"} className='w-10 h-10 p-1 rounded-full bg-skin-fill hover:text-[#0866FF] transition-all cursor-pointer'>
                ...
                <Link href={"/#"} className='w-10 h-10 p-1 rounded-full bg-skin-fill hover:text-[#E4405F] transition-all cursor-pointer'>
